...
function lib:init(ti, dosplash, visiblekey, deleteprevious)
    ...
    if dosplash then
        ...
        sicon.Size = UDim2.new(0, 50, 0, 50)
        sicon.ZIndex = 40
        sicon.Image = "https://media.tenor.com/jxs9tA939I8AAAAM/coffee-loading.gif"
    ...
    searchtextbox.Text = ""
    searchtextbox.TextColor3 = Color3.fromRGB(160, 160, 160)
    ...
    notificon.ImageColor3 = Color3.fromRGB(160, 160, 160)
    ...
    notiftitle.TextColor3 = Color3.fromRGB(160, 160, 160)
    ...
    notiftext.TextColor3 = Color3.fromRGB(160, 160, 160)
    ...
    notif2icon.ImageColor3 = Color3.fromRGB(160, 160, 160)
    ...
    notif2title.TextColor3 = Color3.fromRGB(160, 160, 160)
    ...
    notif2text.TextColor3 = Color3.fromRGB(160, 160, 160)
    ...
    notif2shadow.ImageColor3 = Color3.fromRGB(255, 255, 255)
    ...
    function window:TempNotify(text1, text2, icon)
        ...
        t1.Text = text1
        t1.TextColor3 = Color3.fromRGB(160,160,160)
        t1.TextSize = 28
    ...
    function window:Divider(name)
        ...
        sidebardivider.TextColor3 = Color3.fromRGB(160, 160, 160)
    ...
    function window:Section(name)
        ...
        function sec:TextField(name, placeholder, callback)
            ...
            textfield.Text = name
            textfield.TextColor3 = Color3.fromRGB(160, 160, 160)
